...
public class Estateaccounts extends JFrame {
	...
	private Estateledger ledgerpage;
	...
	public Estateaccounts()
	{
		super ("ESTATE ACCOUNTS");
		setVisible(true);
        ...
        save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                insertTable (ledger,description,debitamount,date,credit,"estate"); 
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picts/grass.png"))); // NOI18N
        ...
        view.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				filterTable (startdate,enddate,"estate",ledger12,sum,creditamount);			 
			}
			});
        ...
        print.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String startdate = formatter6.format(fromdate.getDate());
				String enddate = formatter4.format(todate.getDate());
				createPDF("estate",startdate,enddate);
