...
public class Houseexpense extends JFrame {
	...
	public Houseexpense()
	{
        ...
        getContentPane().add(balance, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 260, 450, 100));
        ...
        getContentPane().add(descriptiontext, new AbsoluteConstraints(160, 280, 510, 50));
        ...
        getContentPane().add(desclabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 130, 30));
        ...
        getContentPane().add(scrollpane, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 1330, 290));
        ...
        save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                insertTable (ledger,description,debitamount,date,credit,"home"); 
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picts/house expense.jpg"))); // NOI18N
        ...
        view.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				filterTable (startdate,enddate,"home",ledger12,sum,creditamount);			 
			}
			});
        ...
        print.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String startdate = formatter6.format(fromdate.getDate());
				String enddate = formatter4.format(todate.getDate());
				//createPDF("home",startdate,enddate);
				...
				try {
					...
					table.setFont(new java.awt.Font("cambria", 0, 18));
	...
	public void refreshTable (String source)
	{
		try
        {
			...
			while (Rs.next()) {
				...
				model1.addRow(new Object[] {Rs.getString(1),Rs.getString(2),Rs.getString(5) ,Rs.getInt(4),Rs.getString(3),Rs.getInt(6),balance} );
				} 
		con.close();
        }
		catch (Exception e1)
