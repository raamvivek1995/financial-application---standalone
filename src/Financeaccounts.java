...
public class Financeaccounts extends JFrame {
	...
	private FinanceLedger ledgerpage;
	...
	public Financeaccounts()
	{
        ...
        save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                insertTable (ledger,description,debitamount,date,credit,"finance"); 
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picts/wallfixfinal.jpg"))); // NOI18N
        ...
        view.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				filterTable (startdate,enddate,"finance",ledger12,sum,creditamount);			 
			}
			});
        ...
        print.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String startdate = formatter6.format(fromdate.getDate());
				String enddate = formatter4.format(todate.getDate());
				createPDF("finance",startdate,enddate);
